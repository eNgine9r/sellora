...
class MetaAdsSyncPreviewService:
    ...
    def preview_sync(self, workspace_id: UUID, account_id: str, date_from: date, date_to: date, read_repository: AdvertisingSyncReadRepository) -> MetaSyncPreviewResultDTO:
        ...
        metric_items = self._preview_metrics(metric_candidates, campaign_matches, campaign_items, existing_metrics)
    ...
    def _preview_metrics(self, candidates: list[AdMetricSyncCandidate], campaign_matches: dict[str, ExistingAdCampaignSnapshot | None], campaign_items: list[MetaCampaignPreviewItemDTO], existing_metrics: list[ExistingAdMetricSnapshot]) -> list[MetaMetricPreviewItemDTO]:
    ...
    def _metric_item(self, candidate: AdMetricSyncCandidate, classification: str, matched_campaign_id: UUID | None = None, matched_metric_id: UUID | None = None, message: str = "", conflicts: list[MetaSyncConflictDTO] | None = None) -> MetaMetricPreviewItemDTO:
