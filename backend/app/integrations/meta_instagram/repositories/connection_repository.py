...
from app.models.meta_instagram import InstagramConnection, MetaOAuthState
...
class InstagramConnectionRepository:
    ...
    def get_by_account(self, instagram_account_id: str) -> InstagramConnection | None:
        return self.db.execute(select(InstagramConnection).where(InstagramConnection.instagram_account_id == instagram_account_id, InstagramConnection.deleted_at.is_(None))).scalar_one_or_none()
