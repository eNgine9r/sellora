...
FIELD_ALIASES: dict[str, dict[str, list[str]]] = {
    ...
    "ad_campaigns": {
        "name": ["Кампанія", "Назва кампанії", "campaign", "Campaign", "Campaign Name", "campaign_name", "name"],
    ...
    "ad_metrics": {
        "campaign_name": ["Кампанія", "Назва кампанії", "campaign", "Campaign", "Campaign Name", "campaign_name"],
        "campaign_id": ["campaign_id"],
        "metric_date": ["Дата", "date", "Date", "metric_date"],
        "spend": ["Витрати", "Витрати на рекламу", "Рекламний бюджет", "Реклама", "Spend", "Ad Spend", "ad_spend", "spend"],
        ...
        "revenue": ["Виручка", "Дохід", "Revenue", "Sales", "revenue"],
        "net_profit": ["Прибуток", "Чистий прибуток", "Net Profit", "Profit", "net_profit"],
    },
    ...
    "advertising_history": {
        "campaign_name": ["Кампанія", "Назва кампанії", "campaign", "Campaign", "Campaign Name", "campaign_name", "Ad Campaign"],
        "platform": ["Платформа", "platform", "Platform", "Джерело реклами"],
        "metric_date": ["Дата", "date", "Date", "Metric Date", "День"],
        "spend": ["Витрати", "Рекламний бюджет", "Spend", "Ad Spend", "ad_spend", "Реклама", "Вартість реклами"],
        "impressions": ["Покази", "Impressions"],
        "reach": ["Охоплення", "Reach"],
        "clicks": ["Кліки", "Clicks"],
        "messages": ["Повідомлення", "Messages", "Direct", "Діалоги"],
        "leads": ["Ліди", "Leads", "Заявки"],
        "orders": ["Замовлення", "Orders", "Purchases"],
        "revenue": ["Дохід", "Виручка", "Revenue", "Sales", "Виторг"],
