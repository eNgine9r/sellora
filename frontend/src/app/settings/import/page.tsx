...
export default function ImportCenterPage() {
  ...
  const suggestMutation = useMutation({ mutationFn: () => suggestImportMapping(workspaceId, jobId, sheetName, entityType, token), onSuccess: (response) => { setSuggestion(response); setMapping(response.suggested_mapping); } });
  ...
  const dryRunMutation = useMutation({ mutationFn: () => dryRunImport(workspaceId, jobId, entityType, sheetName, mapping, token), onSuccess: setDryRunReport });
