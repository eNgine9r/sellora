...
const checks = [
  ...
  ["add user modal exists", read("frontend/src/app/settings/team/page.tsx").includes("Додати користувача")],
  ...
  ["access denied labels exist", read("frontend/src/app/settings/workspace/page.tsx").includes("У вас немає доступу") && read("frontend/src/app/settings/team/page.tsx").includes("У вас немає доступу")],
