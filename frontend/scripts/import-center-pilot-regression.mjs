...
const checks = [
  ...
  ["execute confirmation and duplicate protection", files.page.includes("ConfirmationDialog") && files.page.includes("data-import-execute-trigger") && files.page.includes("!executeMutation.isPending") && files.pilotCopy.includes("executeConfirmTitle")],
