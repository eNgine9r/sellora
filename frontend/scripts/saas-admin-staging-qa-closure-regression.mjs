...
const checks = [
  ...
  ["staging URLs documented without credentials", report.includes("https://sellora-web-staging.vercel.app") && report.includes("https://sellora-api-staging.onrender.com") && !report.includes("testtest")],
  ...
  ["no passwords are committed in QA closure report", !/testtest|password:\s*\S+|пароль:\s*\S+/i.test(report)],
